...
class CurrencyIO internal constructor(
    ...
    override fun toString(): String = "CurrencyIO(isoCode=$isoCode, defaultFractionDigits=$defaultFractionDigits, numericCode=$numericCode)"
    ...
    companion object {
        ...
        fun forCode(isoCode: String): CurrencyIO = forCodeOrNull(isoCode) ?: error("Invalid ISO 4217 currency code: $isoCode")

        fun forCodeOrNull(isoCode: String): CurrencyIO? = allByCode[isoCode]
    }
}
