...
class PercentageInputActivityTest {
    ...
    fun launchesWithRequestAndSubmitsResult() {
        ...
        scenario.result.let { result ->
            ...
            val percentageInputResult = Json.decodeFromString<PercentageInputResult.Success>(resultJson)
            assertEquals(PercentIO.of(10), percentageInputResult.percent)
            assertEquals(mapOf("test" to "value"), percentageInputResult.extras)
        }
    }
